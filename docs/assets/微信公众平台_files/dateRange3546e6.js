...
f.appendChild(u));c&&c!==r&&c!==h[y];)g=c.nextSibling,f.appendChild(t?c:c.cloneNode(!0)),
c=g;
f=u;
}
f=d,m[p]||(f.appendChild(m[p-1].cloneNode(!1)),f=f.firstChild);
for(var b,y=p;b=h[y];y++){
if(c=b.previousSibling,b==r?i||3!=e.endContainer.nodeType||(f.appendChild(l.createTextNode(r.substringData(0,s))),
t&&r.deleteData(0,s)):(u=b.cloneNode(!1),f.appendChild(u)),y!=p||!m[p])for(;c&&c!==o;)b=c.previousSibling,
...
function o(e,t){
try{
if(l&&v.inDoc(l,e))if(l.nodeValue.replace(y,"").length)l.nodeValue=l.nodeValue.replace(y,"");else{
var n=l.parentNode;
...
var y;
if("span"==e&&t.style&&/text\-decoration/.test(t.style)&&(y=v.findParentByTagName(c,"a",!0))?(v.setAttributes(y,t),
v.remove(c,!0),c=y):(v.mergeSibling(c),v.clearEmptySibling(c)),v.mergeChild(c,t),
...
h=l.index;
try{
if(h>p&&n(y,e.slice(p,h)),l[3])y=i(y,l[3].toLowerCase(),l[4]);else if(l[1]){
if("root"!=y.type){
...
return p<e.length&&n(y,e.slice(p)),g;
...
if(a=v.findPreviousSibling(c,n,!1)){
c=a;
break;
}
}
...
if(m&&v.isBlockElm(m)&&(u=m.previousSibling)&&v.isBlockElm(u)){
...
v.remove(m)):v.isFillChar(m,!0)&&(m.nodeValue=m.nodeValue.replace(y,""),i.startOffset--,
i.collapsed&&i.collapse(!0)));
var C=v.findParentByTagName(i.startContainer,"li",!0);
if(C){
for(var N,x;m=o.firstChild;){
for(;m&&(3==m.nodeType||!v.isBlockElm(m)||"HR"==m.tagName);)N=m.nextSibling,i.insertNode(m).collapse(),
l.push(m),x=m,m=N;
...
for(;m=o.firstChild;){
if(b){
for(var E=r.document.createElement("p");m&&(3==m.nodeType||!f.$block[m.tagName]);)g=m.nextSibling,
E.appendChild(m),m=g;
E.firstChild&&(m=E);
}
if(i.insertNode(m),l.push(m),g=m.nextSibling,!b&&m.nodeType==v.NODE_ELEMENT&&v.isBlockElm(m)&&(h=v.findParent(m,function(e){
...
v.trimWhiteTextNode(u),u.childNodes.length||v.remove(u),!s.ie&&(N=m.nextSibling)&&v.isBlockElm(N)&&N.lastChild&&!v.isBr(N.lastChild)&&N.appendChild(r.document.createElement("br")),
b=1;
}
var N=m.nextSibling;
if(!o.firstChild&&N&&v.isBlockElm(N)){
i.setStart(N,0).collapse(!0);
break;
}
i.setEndAfter(m).collapse();
}
if(m=i.startContainer,g&&v.isBr(g)&&v.remove(g),v.isBlockElm(m)&&v.isEmptyNode(m))if(g=m.nextSibling)v.remove(m),
1==g.nodeType&&f.$block[g.tagName]&&i.setStart(g,0).collapse(!0).shrinkBoundary();else try{
...
i=r.selection.getRange(),i.scrollToView(r.autoHeightEnabled,r.autoHeightEnabled?v.getXY(r.iframe).y:0),
...
if(a=l.document.createTextNode("font"),!m||m.children.length||m[s.ie?"innerText":"textContent"].replace(y,"").length){
...
for(var h,g=e.startContainer,y=e.collapsed;1==g.nodeType&&v.isEmptyNode(g)&&f.$removeEmpty[g.tagName];)h=g.parentNode,
e.setStartBefore(g),e.startContainer===e.endContainer&&e.endOffset--,v.remove(g),
g=h;
if(!y)for(g=e.endContainer;1==g.nodeType&&v.isEmptyNode(g)&&f.$removeEmpty[g.tagName];)h=g.parentNode,
...
for(var p=i.cloneRange(),g=1==p.startContainer.nodeType?p.startContainer:p.startContainer.parentNode,y=g,b=1;;){
if(v.isBody(g)){
y!==g?i.collapsed?(p.selectNode(y),b=0):p.setStartBefore(y):p.setStart(g,0);
break;
}
if(!r[g.tagName]){
i.collapsed?(p.selectNode(y),b=0):p.setStartBefore(y);
break;
}
y=g,g=g.parentNode;
}
if(b)for(y=g=g=1==p.endContainer.nodeType?p.endContainer:p.endContainer.parentNode;;){
if(v.isBody(g)){
y!==g?p.setEndAfter(y):p.setEnd(g,g.childNodes.length);
break;
}
if(!r[g.tagName]){
p.setEndAfter(y);
...
e.options.autoClearEmptyNode=!1,e.filterInputRule(n),e.options.autoClearEmptyNode=m,
...
var o,r=this,l=r.options.maxUndoCount||20,d=r.options.maxInputCount||20,u=new RegExp(v.fillChar+"|</hr>","gi"),f={
ol:1,
ul:1,
table:1,
tbody:1,
...
if(!(p[r]||t.ctrlKey||t.metaKey||t.shiftKey||t.altKey)){
if(y)return;
...
if(!(p[n]||t.ctrlKey||t.metaKey||t.shiftKey||t.altKey)){
if(y)return;
...
for(p.parentNode.insertBefore(y,p);p.firstChild;)y.appendChild(p.firstChild);
v.remove(p);
}
for(var b,C=e.querySelectorAll("meta"),u=0;b=C[u++];)v.remove(b);
var m=e.querySelectorAll("br");
for(u=0;b=m[u++];)/^apple-/i.test(b.className)&&v.remove(b);
}
if(s.gecko){
var N=e.querySelectorAll("[_moz_dirty]");
for(u=0;b=N[u++];)b.removeAttribute("_moz_dirty");
}
if(!s.ie)for(var b,x=e.querySelectorAll("span.Apple-style-span"),u=0;b=x[u++];)v.remove(b,!0);
...
var p=v.getStyle(r,"list-style-type"),g=v.getStyle(r,"margin-left"),y=v.getStyle(r,"margin-right"),b="";
p&&(b+="list-style-type:"+p+";"),g&&(b+="margin-left:"+g+";"),y&&(b+="margin-right:"+y+";"),
r.style.cssText=b,r.className=c.trim(r.className.replace(/list-paddingleft-\w+/,""))+" list-paddingleft-"+h,
...
next=d.nextSibling,C=l.document.createElement("p"),v.fillNode(l.document,C),y=d.parentNode,
w&&next?(u.setStart(next,0).collapse(!0).select(!0),v.remove(d)):((w||next)&&w?d.parentNode.parentNode.insertBefore(C,y.nextSibling):y.parentNode.insertBefore(C,y),
v.remove(d),y.firstChild||v.remove(y),u.setStart(C,0).setCursor()),void n();
}
if(d=v.findParentByTagName(u.startContainer,"li",!0)){
if(v.isEmptyBlock(d)){
g=u.createBookmark();
var y=d.parentNode;
if(d!==y.lastChild?(v.breakParent(d,y),r(d)):(y.parentNode.insertBefore(d,y.nextSibling),
v.isEmptyNode(y)&&v.remove(y)),!f.$list[d.parentNode.tagName])if(v.isBlockElm(d.firstChild))v.remove(d,!0);else{
...
var x=N.nextSibling;
b=x.firstChild,b||(C=l.document.createElement("p"),v.fillNode(l.document,C),x.appendChild(C),
b=C),v.isEmptyNode(b)&&(b.innerHTML="",v.fillNode(l.document,b)),u.setStart(b,0).collapse(!0).shrinkBoundary().select(),
v.remove(N);
...
var y=v.findParentByTagName(m,["ol","ul"]);
return v.breakParent(m,y),r(m),l.fireEvent("contentchange"),u.setStart(m,0).setCursor(!1,!0),
...
v.isBlockElm(b))if(v.isEmptyNode(b))for(w.appendChild(b),u.setStart(b,0).setCursor(!1,!0);d.firstChild;)w.appendChild(d.firstChild);else N=l.document.createElement("span"),
...
var y=d.parentNode,g=u.createBookmark();
if(v.isTagNode(y.parentNode,"ol ul"))y.parentNode.insertBefore(d,y),v.isEmptyNode(y)&&v.remove(y);else{
for(;d.firstChild;)y.parentNode.insertBefore(d.firstChild,y);
v.remove(d),v.isEmptyNode(y)&&v.remove(y);
}
...
var p=h.parentNode,g=l.document.createElement(p.tagName),y=c.indexOf(m[g.tagName],t(p)||v.getComputedStyle(p,"list-style-type")),b=y+1==m[g.tagName].length?0:y+1,C=m[g.tagName][b];
...
if(e(r))return!0;
var p=r.parentNode,g=l.document.createElement(p.tagName),y=c.indexOf(m[g.tagName],t(p)||v.getComputedStyle(p,"list-style-type"));
y=y+1==m[g.tagName].length?0:y+1;
var C=m[g.tagName][y];
...
var h,p,g,y,b=s.createBookmark(!0),C=a(r.document.getElementById(b.start)),N=0,x=a(r.document.getElementById(b.end)),w=0;
if(C||x){
if(C&&(h=C.parentNode),b.end||(x=C),x&&(p=x.parentNode),h===p){
for(;C!==x;){
if(y=C,C=C.nextSibling,!v.isBlockElm(y.firstChild)){
for(var E=r.document.createElement("p");y.firstChild;)E.appendChild(y.firstChild);
y.appendChild(E);
}
m.appendChild(y);
}
if(y=r.document.createElement("span"),h.insertBefore(y,x),!v.isBlockElm(x.firstChild)){
for(E=r.document.createElement("p");x.firstChild;)E.appendChild(x.firstChild);
x.appendChild(E);
}
m.appendChild(x),v.breakParent(y,h),v.isEmptyNode(y.previousSibling)&&v.remove(y.previousSibling),
v.isEmptyNode(y.nextSibling)&&v.remove(y.nextSibling);
...
}else g=r.document.createElement(u),o(g,n),g.appendChild(m),y.parentNode.insertBefore(g,y);
return v.remove(y),g&&i(g,u,n),void s.moveToBookmark(b).select();
}
if(C){
for(;C;){
if(y=C.nextSibling,v.isTagNode(C,"ol ul"))m.appendChild(C);else{
...
P&&O(P)&&(y=v.getNextDomNode(A,!1,l),y&&v.isBookmarkNode(y)&&(P=v.getNextDomNode(y,!1,l),
A=y)),M.setEndAfter(A),P=v.getNextDomNode(A,!1,l);
...
if("p"==n)s.ie||(l=v.findParentByTagName(a.startContainer,["ol","ul","p","h1","h2","h3","h4","h5","h6","blockquote","caption"],!0),
...
if(g.innerHTML=m+v.fillChar,u.collapsed)u.insertNode(g.cloneNode(!0).firstChild).setCursor(!0);else if(l=v.findParent(u.startContainer,b),
d=v.findParent(u.endContainer,b),l&&d&&l===d)u.deleteContents(),u.insertNode(g.cloneNode(!0).firstChild).setCursor(!0);else{
var y=u.createBookmark(),b=function(e){
return v.isBlockElm(e)&&!c[e.tagName.toLowerCase()];
};
u.enlarge(!0);
for(var C=u.createBookmark(),N=v.getNextDomNode(C.start,!1,b);N&&!(v.getPosition(N,C.end)&v.POSITION_FOLLOWING);)N.insertBefore(g.cloneNode(!0).firstChild,N.firstChild),
N=v.getNextDomNode(N,!1,b);
...
g||y&&s.ie?("absolute"!=f.style.position&&(f.style.position="absolute"),f.style.top=(document.body.scrollTop||document.documentElement.scrollTop)-m+d+"px"):(s.ie7Compat&&C&&(C=!1,
...
function i(){
C=!0,b&&b.parentNode&&b.parentNode.removeChild(b),f&&(f.style.cssText=u,f.style.marginLeft="0px");
}
function o(){
...
if(l){
var u,f,m,h,p=UE.ui.uiUtils,g=s.ie&&s.version<=6,y=s.quirks,b=document.createElement("div"),C=!0,N=c.defer(function(){
o();
},s.ie?200:100,!0);
...
r.fireEvent("stop_toolbar_float"),v.on(window,["scroll","resize"],o),r.addListener("keydown",N);
}),r.addListener("ready",function(){
e(r)&&(h=p.getClientRect,f=r.ui.getDom("toolbarbox"),m=h(f).top,u=f.style.cssText,
b.style.height=f.offsetHeight+53+"px",g&&t(),v.on(window,["scroll","resize"],o),
...
for(var g=0;h>g;g++)for(var y=0;p>y;y++)this.indexTable[l+g][m+y]={
rowIndex:l,
cellIndex:u,
colIndex:m,
rowSpan:h,
...
for(g=0;n>g;g++)for(y=0;o>y;y++)void 0===this.indexTable[g][y]&&(s=t[g],d=s.cells[s.cells.length-1],
d=d?d.cloneNode(!0):this.table.ownerDocument.createElement("td"),this.setCellContent(d),
1!==d.colSpan&&(d.colSpan=1),1!==d.rowSpan&&(d.rowSpan=1),s.appendChild(d),this.indexTable[g][y]={
rowIndex:g,
...
var b=v.getElementsByTagName(this.table,"td"),C=[];
...
var h=[],p={};
for(r=0;i>r;r++){
var g=n[r].rowIndex,y=n[r].cellIndex,b=g+"_"+y;
p[b]||(p[b]=1,s=this.getCell(g,y),h.push(s));
}
var C=[];
c.each(h,function(e){
...
for(var h=i.cellsRange.beginRowIndex,p=i.cellsRange.endRowIndex,g=0,y=v.getElementsByTagName(r,"tr"),b=h;p>=b;b++)o+=y[b].offsetHeight,
g+=1;
t=g;
}
...
n=r(t);
var a=y(o,n),l=v.findParentByTagName(o,"table",!0);
if(m(l,o,t,!0)){
...
function x(e){
s.ie&&(e=T(e)),E(),Y=!0,j=setTimeout(function(){
S(e);
},Z);
}
function w(e,t){
...
if(u){
var p=u.rows[0].cells[0],g=v.findParentByTagName(a.selection.getStart(),["td","th"],!0),y=u.previousSibling;
if(p===g&&(!y||1==y.nodeType&&"TABLE"==y.tagName)&&v.isStartInblock(h)){
var b=v.findParent(a.selection.getStart(),function(e){
return v.isBlockElm(e);
},!0);
b&&(/t(h|d)/i.test(b.tagName)||b===g.firstChild)&&(a.execCommand("insertparagraphbeforetable"),
v.preventDefault(i));
}
}
}
...
var g=tt(p);
if(r){
var y=g.getCellInfo(p).rowIndex;
"TH"==p.tagName&&y++;
for(var b,C=0;b=e[C++];){
for(var N,x=g.insertRow(y++,"td"),w=0;N=b[w];w++){
var E=x.cells[w];
...
for(var b,C=0;b=e[C++];){
m=p;
for(var N,w=0;N=b[w++];)if(p)p.innerHTML=N.innerHTML,N.getAttribute("width")&&p.setAttribute("width",N.getAttribute("width")),
...
for(var b,C=0;b=e[C++];){
for(var N,x=f.insertRow(f.rows.length),w=0;N=b[w++];)S=et.cloneCell(N,null,!0),v.removeAttributes(S,["class"]),
x.appendChild(S);
...
}),W.addListener("mousedown",b),W.addListener("mouseup",k),v.on(W.body,"dragstart",function(e){
...
v.insertAfter(a,y),v.fillNode(o.document,y),n.setStart(y,0).setCursor();
}
}else{
...
this.value!=i&&(this.editor.fireEvent("reportAddNum",65080,8,1),this.editor.fireEvent("reportAddNum",65080,l[i],1),
...
C=y-p.x,N=b-p.y,C>=v&&(h=!0,m.style.width=C+"px"),N>=g&&(h=!0,m.style.height=N+"px");
}
function n(){
...
var o=document,r=this.editor,l=r.container,d=r.document,c=this.getDom("toolbarbox"),u=this.getDom("bottombar"),f=this.getDom("scale"),m=this.getDom("scalelayer"),h=!1,p=null,g=0,v=r.options.minFrameWidth,y=0,b=0,C=0,N=0;
...
});define("common/wx/tooltip.js",["tpl/tooltip.html.js","widget/tooltip.css"],function(o,t,i){
"use strict";
var s=o("tpl/tooltip.html.js");
...
this.options=o=$.extend(!0,{},n,o),this.$dom=$(this.options.dom),this.init();
};
p.prototype={
constructor:p,
init:function(){
var o=this;
o.pops=[],o.$dom.each(function(){
var t=$(this),i=t.data("tooltip"),n=$(template.compile(s)(i?$.extend(!0,{},o.options,{
content:i
}):o.options));
o.pops.push(n),$("body").append(n),n.css("display","none"),t.on("mouseenter",function(){
var i=t.offset();
n.css({
top:i.top-(o.options.position.y||0)-n.height(),
left:i.left+t.width()/2-n.width()/2+(o.options.position.x||0)
}),n.show();
}).on("mouseleave",function(){
n.hide();
}),t.data("tooltip_pop",n);
});
},
show:function(){
for(var o=this,t=0,i=o.pops.length,t=0;i>t;t++)o.pops[t].show();
},
hide:function(){
for(var o=this,t=0,i=o.pops.length,t=0;i>t;t++)o.pops[t].hide();
},
destory:function(){
for(var o=this,t=o.pops.length,i=0;t>i;i++)o.pops[i].remove();
}
},i.exports=p;
