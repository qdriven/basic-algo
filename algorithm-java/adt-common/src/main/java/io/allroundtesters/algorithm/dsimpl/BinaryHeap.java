package io.allroundtesters.algorithm.dsimpl;
...
public interface BinaryHeap<T extends Comparable<T>> extends IHeap<T> {
    ...
    public static class JavaCompatibleBinaryHeapArray<T extends Comparable<T>> extends AbstractCollection<T> {
    ...
    public static class JavaCompatibleBinaryHeapTree<T extends Comparable<T>> extends AbstractCollection<T> {
