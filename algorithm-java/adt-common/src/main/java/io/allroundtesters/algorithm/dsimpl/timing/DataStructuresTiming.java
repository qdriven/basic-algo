package io.allroundtesters.algorithm.dsimpl.timing;

import io.hedwig.alg.algorithm.dsimpl.*;
import io.hedwig.alg.algorithm.dsimpl.*;
import io.hedwig.alg.algorithm.dsimpl.List;
import io.hedwig.alg.algorithm.dsimpl.Queue;
import io.hedwig.alg.algorithm.dsimpl.Stack;
import io.hedwig.alg.algorithm.dsimpl.TreeMap;
...
public class DataStructuresTiming {
    ...
    private static boolean testHashMap() {
        ...
        Map<Integer,String> jMap = map.toMap();
    ...
    private static boolean testJavaHashMap() {
        ...
        Map<Integer,String> map = new HashMap<Integer,String>(unsorted.length/2);
    ...
    private static boolean testJavaMinHeap() {
        PriorityQueue<Integer> minArrayHeap = new PriorityQueue<Integer>(10,
    ...
    private static boolean testJavaMaxHeap() {
        PriorityQueue<Integer> maxArrayHeap = new PriorityQueue<Integer>(10,
                new Comparator<Integer>() {
    ...
    private static boolean testJavaArrayList() {
        if (!testJavaCollection(new ArrayList<Integer>(), Type.Integer,"Java's List [array]")) return false;
        return true;
    }

    private static boolean testJavaLinkedList() {
        if (!testJavaCollection(new LinkedList<Integer>(), Type.Integer,"Java's List [linked]")) return false;
        return true;
    }

    private static boolean testJavaArrayQueue() {
        String aName = "Java's Queue [array]";
        Deque<Integer> aCollection = new ArrayDeque<Integer>();
    ...
    private static boolean testJavaLinkedQueue() {
        ...
        Deque<Integer> lCollection = new LinkedList<Integer>();
    ...
    private static boolean testJavaRedBlackIntegerTree() {
        ...
        TreeSet<Integer> aCollection = new TreeSet<Integer>();
        if (!testJavaCollection(aCollection, Type.Integer,aName)) return false;
        return true;
    }
    ...
    private static boolean testJavaStack() {
        ...
        Stack<Integer> aCollection = new Stack<Integer>();
        if (!testJavaCollection(aCollection, Type.Integer,aName)) return false;
        return true;
    }
    ...
    private static boolean testRadixTrie() {
        ...
        Map<String,Integer> jMap = map.toMap();
    ...
    private static <K,V> boolean testJavaMap(Map<K,V> map, Type keyType, String name) {
